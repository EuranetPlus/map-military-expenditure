export const config = {
	mapTitle: 'military-expenditure-total', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-military-expenditure.vercel.app/', // The url provided when deploying the map on Vercel
